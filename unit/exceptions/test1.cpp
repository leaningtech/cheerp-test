...
// RUN: %cheerp_clang -O1 -frtti -I%S/.. -cheerp-bounds-check -cheerp-fix-wrong-func-casts -target cheerp -fexceptions %s -o %t.js
...
// CHECK: Throw basic type 1/2 : SUCCESS
// CHECK: Throw basic type 2/2 : SUCCESS
// CHECK: Throw pointer type 1/2 : SUCCESS
// CHECK: Throw pointer type 2/2 : SUCCESS
// CHECK: Throw object type 1/4 : SUCCESS
// CHECK: Throw object type 2/4 : SUCCESS
// CHECK: Throw object type 3/4 : SUCCESS
// CHECK: Throw object type 4/4 : SUCCESS
// CHECK: Throw object type ref 1/4 : SUCCESS
// CHECK: Throw object type ref 2/4 : SUCCESS
// CHECK: Throw object type ref 3/4 : SUCCESS
// CHECK: Throw object type ref 4/4 : SUCCESS
// CHECK: Throw object type ptr 1/4 : SUCCESS
// CHECK: Throw object type ptr 2/4 : SUCCESS
// CHECK: Throw object type ptr 3/4 : SUCCESS
// CHECK: Throw object type ptr 4/4 : SUCCESS
// CHECK: Throw object type ptr and catch by base type 1/4 : SUCCESS
// CHECK: Throw object type ptr and catch by base type 2/4 : SUCCESS
// CHECK: Throw object type ptr and catch by base type 3/4 : SUCCESS
// CHECK: Throw object type ptr and catch by base type 4/4 : SUCCESS
// CHECK: Throw object type ptr and catch by base type pointer 1/4 : SUCCESS
// CHECK: Throw object type ptr and catch by base type pointer 2/4 : SUCCESS
// CHECK: Throw object type ptr and catch by base type pointer 3/4 : SUCCESS
// CHECK: Throw object type ptr and catch by base type pointer 4/4 : SUCCESS
// CHECK: Throw object type ptr and catch by virtual base type 1/4 : SUCCESS
// CHECK: Throw object type ptr and catch by virtual base type 2/4 : SUCCESS
// CHECK: Throw object type ptr and catch by virtual base type 3/4 : SUCCESS
// CHECK: Throw object type ptr and catch by virtual base type 4/4 : SUCCESS
// CHECK: Throw object type ptr and catch by virtual base type pointer 1/4 : SUCCESS
// CHECK: Throw object type ptr and catch by virtual base type pointer 2/4 : SUCCESS
// CHECK: Throw object type ptr and catch by virtual base type pointer 3/4 : SUCCESS
// CHECK: Throw object type ptr and catch by virtual base type pointer 4/4 : SUCCESS
// CHECK: Throw a null pointer and catch it 1/1 : SUCCESS
// CHECK: Throw nullptr_t type and catch it 1/1 : SUCCESS
// CHECK: Throw a client::Object* and catch it 1/1 : SUCCESS
// CHECK: Throw object type rethrow 1/4 : SUCCESS
// CHECK: Throw object type rethrow 2/4 : SUCCESS
// CHECK: Throw object type rethrow 3/4 : SUCCESS
// CHECK: Throw object type rethrow 4/4 : SUCCESS
// CHECK: Throw a client::Object* and rethrow it 1/1 : SUCCESS
// CHECK: Test resume unwinding 1/4 : SUCCESS
// CHECK: Test resume unwinding 2/4 : SUCCESS
// CHECK: Test resume unwinding 3/4 : SUCCESS
// CHECK: Test resume unwinding 4/4 : SUCCESS
// CHECK: Capture and rethrow current exception 1/4 : SUCCESS
// CHECK: Capture and rethrow current exception 2/4 : SUCCESS
// CHECK: Capture and rethrow current exception 3/4 : SUCCESS
// CHECK: Capture and rethrow current exception 4/4 : SUCCESS
// CHECK: Throw exception during another exception cleanup 1/1 : SUCCESS
// CHECK: Catchall clause 1/1 : SUCCESS
