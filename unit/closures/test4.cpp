...
// CHECK: Calling functor through EventListener 1/1 : SUCCESS
// CHECK: Calling std::function through EventListener 1/1 : SUCCESS
// CHECK: Escaping std::function lifecycle 1/2 : SUCCESS
// CHECK: Escaping std::function lifecycle 2/2 : SUCCESS
