...
// CHECK: B::bar is not called : SUCCESS
// CHECK: A::foo is called : SUCCESS
// CHECK: A::bar is not called : SUCCESS
// CHECK: B::foo is called : SUCCESS
// CHECK: B::bar is called : SUCCESS
// CHECK: Cast to void support 1/N : SUCCESS
// CHECK: dynamic_cast to empty non-primary base class : SUCCESS
// CHECK: Multiple inheritance support 1/N : SUCCESS
