...
// CHECK: std::map 1/4 : SUCCESS
// CHECK: std::map 2/4 : SUCCESS
// CHECK: std::map 3/4 : SUCCESS
// CHECK: std::map ordering 4/4 : SUCCESS
// CHECK: std::multimap 1/4 : SUCCESS
// CHECK: std::multimap 2/4 : SUCCESS
// CHECK: std::multimap 3/4 : SUCCESS
// CHECK: std::multimap ordering 4/4 : SUCCESS
// CHECK: std::unordered_map 1/4 : SUCCESS
// CHECK: std::unordered_map 2/4 : SUCCESS
// CHECK: std::unordered_map 3/4 : SUCCESS
// CHECK: std::unordered_map ordering 4/4 : SUCCESS
// CHECK: std::unordered_map of pointers 1/4 : SUCCESS
// CHECK: std::unordered_map of pointers 2/4 : SUCCESS
// CHECK: std::unordered_map of pointers 3/4 : SUCCESS
