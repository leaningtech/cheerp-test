...
// CHECK: std::set<std::string> 2/4 : SUCCESS
// CHECK: std::set<std::string> 3/4 : SUCCESS
// CHECK: std::set<std::string> ordering 4/4 : SUCCESS
// CHECK: std::set<std::wstring> 1/4 : SUCCESS
// CHECK: std::set<std::wstring> 2/4 : SUCCESS
