...
// CHECK: JS TMap::get 2/2 : SUCCESS
// CHECK: JS TMap::get_size() 1/2 : SUCCESS
// CHECK: JS TMap::get_size() 2/2 : SUCCESS
// CHECK: JS TMap::has 1/2 : SUCCESS
// CHECK: JS TMap::has 2/2 : SUCCESS
// CHECK: JS TMap::get_delete_ 1/2 : SUCCESS
