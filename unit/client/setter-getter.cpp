...
// CHECK: set_/get_ in namespace 1/2 : SUCCESS
// CHECK: set_/get_ in namespace 2/2 : SUCCESS
// CHECK: get_* in namespace 1/2 : SUCCESS
// CHECK: get_* in namespace 2/2 : SUCCESS
