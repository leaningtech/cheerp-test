...
// RUN: %node %t_wasm.js 2>&1 | %FileCheck %s
// CHECK: Internal value 1/3 : SUCCESS
// CHECK: Internal value 2/3 : SUCCESS
// CHECK: Internal value 3/3 : SUCCESS
// CHECK: External value 1/3 : SUCCESS
// CHECK: External value 2/3 : SUCCESS
// CHECK: External value 3/3 : SUCCESS
