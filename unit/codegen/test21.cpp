...
// RUN: %cheerp_clang -O1 -frtti -I%S/.. -cheerp-bounds-check -cheerp-fix-wrong-func-casts -target cheerp -cheerp-use-bigints %s -o %t.js
// RUN: %node %t.js 2>&1 | %FileCheck %s
...
// RUN: %node %t_wasm.js 2>&1 | %FileCheck %s
// CHECK: int64_t representation 1/N : SUCCESS
// CHECK: int64_t representation 2/N : SUCCESS
// CHECK: int64_t representation 3/N : SUCCESS
// CHECK: int64_t representation 4/N : SUCCESS
// CHECK: int64_t shl support 1/N : SUCCESS
// CHECK: int64_t shl support 2/N : SUCCESS
// CHECK: int64_t shl support 3/N : SUCCESS
// CHECK: int64_t shl support 4/N : SUCCESS
// CHECK: int64_t shl support 5/N : SUCCESS
// CHECK: int64_t shr support 1/N : SUCCESS
// CHECK: int64_t shr support 2/N : SUCCESS
// CHECK: int64_t shr support 3/N : SUCCESS
// CHECK: int64_t shr support 4/N : SUCCESS
// CHECK: int64_t shr support 5/N : SUCCESS
// CHECK: int64_t shr support 6a/N : SUCCESS
// CHECK: int64_t shr support 6b/N : SUCCESS
// CHECK: int64_t and support 1/N : SUCCESS
// CHECK: int64_t and support 2/N : SUCCESS
// CHECK: int64_t or support 1/N : SUCCESS
// CHECK: int64_t or support 2/N : SUCCESS
// CHECK: int64_t or support 3/N : SUCCESS
// CHECK: int64_t or support 4/N : SUCCESS
// CHECK: int64_t xor support 1/N : SUCCESS
// CHECK: int64_t xor support 2/N : SUCCESS
// CHECK: int64_t xor support 3/N : SUCCESS
// CHECK: int64_t not support 1/N : SUCCESS
// CHECK: int64_t not support 2/N : SUCCESS
// CHECK: int64_t not support 3/N : SUCCESS
// CHECK: int64_t add support 1/N : SUCCESS
// CHECK: int64_t add support 2/N : SUCCESS
// CHECK: int64_t add support 3/N : SUCCESS
// CHECK: int64_t add support 4/N : SUCCESS
// CHECK: int64_t sub support 1/N : SUCCESS
// CHECK: int64_t sub support 2/N : SUCCESS
// CHECK: int64_t sub support 3/N : SUCCESS
// CHECK: int64_t sub support 4/N : SUCCESS
// CHECK: int64_t sub support 5/N : SUCCESS
// CHECK: int64_t sub support 6/N : SUCCESS
// CHECK: int64_t mul support 1/N : SUCCESS
// CHECK: int64_t mul support 2/N : SUCCESS
// CHECK: int64_t mul support 3/N : SUCCESS
// CHECK: int64_t mul support 4/N : SUCCESS
// CHECK: int64_t mul support 5/N : SUCCESS
// CHECK: int64_t div support 1/N : SUCCESS
// CHECK: int64_t div support 2/N : SUCCESS
// CHECK: int64_t div support 3a/N : SUCCESS
// CHECK: int64_t div support 3b/N : SUCCESS
// CHECK: int64_t div support 4/N : SUCCESS
// CHECK: int64_t mod support 1/N : SUCCESS
// CHECK: int64_t mod support 2/N : SUCCESS
// CHECK: int64_t mod support 3/N : SUCCESS
// CHECK: int64_t neg support 1/N : SUCCESS
// CHECK: int64_t neg support 2/N : SUCCESS
// CHECK: int64_t neg support 3/N : SUCCESS
// CHECK: int64_t neg support 4/N : SUCCESS
// CHECK: int64_t neg support 5/N : SUCCESS
// CHECK: int64_t neg support 6a/N : SUCCESS
// CHECK: int64_t lnot support 1/N : SUCCESS
// CHECK: int64_t lnot support 2/N : SUCCESS
// CHECK: int64_t lnot support 3/N : SUCCESS
// CHECK: int64_t lnot support 4/N : SUCCESS
// CHECK: int64_t and assign support 1/N : SUCCESS
// CHECK: int64_t and assign support 2/N : SUCCESS
// CHECK: int64_t and assign support 3/N : SUCCESS
// CHECK: int64_t and assign support 4/N : SUCCESS
// CHECK: int64_t or assign support 1/N : SUCCESS
// CHECK: int64_t or assign support 2/N : SUCCESS
// CHECK: int64_t or assign support 3/N : SUCCESS
// CHECK: int64_t or assign support 4/N : SUCCESS
// CHECK: int64_t xor assign support 1/N : SUCCESS
// CHECK: int64_t xor assign support 2/N : SUCCESS
// CHECK: int64_t xor assign support 3/N : SUCCESS
// CHECK: int64_t xor assign support 4/N : SUCCESS
// CHECK: int64_t add assign support 1/N : SUCCESS
// CHECK: int64_t add assign support 2/N : SUCCESS
// CHECK: int64_t add assign support 3/N : SUCCESS
// CHECK: int64_t add assign support 4/N : SUCCESS
// CHECK: int64_t sub assign support 1/N : SUCCESS
// CHECK: int64_t sub assign support 2/N : SUCCESS
// CHECK: int64_t sub assign support 3/N : SUCCESS
// CHECK: int64_t sub assign support 4/N : SUCCESS
// CHECK: int64_t mod assign support 1/N : SUCCESS
// CHECK: int64_t mod assign support 2/N : SUCCESS
// CHECK: int64_t mod assign support 3a/N : SUCCESS
// CHECK: int64_t mod assign support 3b/N : SUCCESS
// CHECK: int64_t mod assign support 4/N : SUCCESS
// CHECK: int64_t mul assign support 1/N : SUCCESS
// CHECK: int64_t mul assign support 2/N : SUCCESS
// CHECK: int64_t mul assign support 3/N : SUCCESS
// CHECK: int64_t mul assign support 4/N : SUCCESS
// CHECK: int64_t div assign support 1/N : SUCCESS
// CHECK: int64_t div assign support 2/N : SUCCESS
// CHECK: int64_t mod assign support 3a/N : SUCCESS
// CHECK: int64_t mod assign support 3b/N : SUCCESS
// CHECK: int64_t div assign support 4/N : SUCCESS
// CHECK: int64_t shl assign support 1/N : SUCCESS
// CHECK: int64_t shl assign support 2/N : SUCCESS
// CHECK: int64_t shl assign support 3/N : SUCCESS
// CHECK: int64_t shr assign support 1/N : SUCCESS
// CHECK: int64_t shr assign support 2/N : SUCCESS
// CHECK: int64_t shr assign support 3a/N : SUCCESS
// CHECK: int64_t shr assign support 3b/N : SUCCESS
// CHECK: int64_t compound assign result support : SUCCESS
// CHECK: int64_t lt support 1/N : SUCCESS
// CHECK: int64_t lt support 2/N : SUCCESS
// CHECK: int64_t lt support 3/N : SUCCESS
// CHECK: int64_t lt support 4/N : SUCCESS
// CHECK: int64_t lt support 5/N : SUCCESS
// CHECK: int64_t lt support 6/N : SUCCESS
// CHECK: int64_t lt support 7/N : SUCCESS
// CHECK: int64_t lt support 8/N : SUCCESS
// CHECK: int64_t le support 1/N : SUCCESS
// CHECK: int64_t le support 2/N : SUCCESS
// CHECK: int64_t le support 3/N : SUCCESS
// CHECK: int64_t le support 4/N : SUCCESS
// CHECK: int64_t le support 5/N : SUCCESS
// CHECK: int64_t le support 6/N : SUCCESS
// CHECK: int64_t le support 7/N : SUCCESS
// CHECK: int64_t le support 8/N : SUCCESS
// CHECK: int64_t gt support 1/N : SUCCESS
// CHECK: int64_t gt support 2/N : SUCCESS
// CHECK: int64_t gt support 3/N : SUCCESS
// CHECK: int64_t gt support 4/N : SUCCESS
// CHECK: int64_t gt support 5/N : SUCCESS
// CHECK: int64_t gt support 6/N : SUCCESS
// CHECK: int64_t gt support 7/N : SUCCESS
// CHECK: int64_t gt support 8/n : SUCCESS
// CHECK: int64_t ge support 1/N : SUCCESS
// CHECK: int64_t ge support 2/N : SUCCESS
// CHECK: int64_t ge support 3/N : SUCCESS
// CHECK: int64_t ge support 4/N : SUCCESS
// CHECK: int64_t ge support 5/N : SUCCESS
// CHECK: int64_t ge support 6/N : SUCCESS
// CHECK: int64_t ge support 7/N : SUCCESS
// CHECK: int64_t ge support 8/n : SUCCESS
// CHECK: int64_t zero is false 1/N : SUCCESS
// CHECK: int64_t cast to float support 1/N : SUCCESS
// CHECK: int64_t cast to float support 2/N : SUCCESS
// CHECK: int64_t cast to float support 3/N : SUCCESS
// CHECK: int64_t cast to float support 4/N : SUCCESS
// CHECK: int64_t cast to float support 5a/N : SUCCESS
// CHECK: int64_t cast to float support 5b/N : SUCCESS
// CHECK: int64_t cast to float support 6b/N : SUCCESS
// CHECK: int64_t cast to float support 7b/N : SUCCESS
// CHECK: int64_t cast from float support 1/N : SUCCESS
// CHECK: int64_t cast from float support 2/N : SUCCESS
// CHECK: int64_t cast from float support 3/N : SUCCESS
// CHECK: int64_t cast from float support 4/N : SUCCESS
// CHECK: int64_t cast from float support 5a/N : SUCCESS
// CHECK: int64_t cast from float support 6/N : SUCCESS
// CHECK: int64_t cast from float support 7/N : SUCCESS
// CHECK: int64_t cast from float support 8/N : SUCCESS
// CHECK: int64_t post increment support 1/N : SUCCESS
// CHECK: int64_t post increment support 2/N : SUCCESS
// CHECK: int64_t post increment support 3/N : SUCCESS
// CHECK: int64_t pre increment support 1/N : SUCCESS
// CHECK: int64_t pre increment support 2/N : SUCCESS
// CHECK: int64_t pre increment support 3/N : SUCCESS
// CHECK: int64_t post decrement support 1/N : SUCCESS
// CHECK: int64_t post decrement support 2/N : SUCCESS
// CHECK: int64_t post decrement support 3/N : SUCCESS
// CHECK: int64_t pre decrement support 1/N : SUCCESS
// CHECK: int64_t pre decrement support 2/N : SUCCESS
// CHECK: int64_t pre decrement support 3/N : SUCCESS
// CHECK: int64_t struct support 1/N : SUCCESS
// CHECK: int64_t struct support 2/N : SUCCESS
// CHECK: int64_t struct support 3/N : SUCCESS
// CHECK: int64_t list support 1/N : SUCCESS
// CHECK: int64_t list support 2/N : SUCCESS
// CHECK: int64_t reference support 1/N : SUCCESS
// CHECK: int64_t bit fields support 1/N : SUCCESS
// CHECK: int64_t bit fields support 2/N : SUCCESS
// CHECK: int64_t bit fields support 3/N : SUCCESS
// CHECK: int64_t bit fields support 4/N : SUCCESS
// CHECK: int64_t bit fields support 5/N : SUCCESS
// CHECK: int64_t bit fields support 6/N : SUCCESS
// CHECK: int64_t bit fields support 7/N : SUCCESS
// CHECK: int64_t bit fields support 8/N : SUCCESS
// CHECK: int64_t bit fields support 9/N : SUCCESS
// CHECK: int64_t bit fields support 10/N : SUCCESS
// CHECK: int64_t in switch statements : SUCCESS
// CHECK: int64_t vaarg support 1/1 : SUCCESS
