...
// CHECK: Value after the a_cas did not swap : SUCCESS
// CHECK: Return value of a_swap : SUCCESS
// CHECK: Value after a_swap : SUCCESS
// CHECK: Return value of a_fetch_add : SUCCESS
// CHECK: Value after a_fetch_add : SUCCESS
// CHECK: Value after a_and : SUCCESS
// CHECK: Value after a_or : SUCCESS
// CHECK: Value after a_inc : SUCCESS
// CHECK: Value after a_dec : SUCCESS
// CHECK: Value after a_store : SUCCESS
// CHECK: Return of a_ctz_64 : SUCCESS
// CHECK: Return of a_ctz_32 : SUCCESS
// CHECK: Return of a_clz_32 : SUCCESS
