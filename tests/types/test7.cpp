...
void webMain()
{
	...
	assertPrint("JS interoperability using cheerp::jsexport __asm__ 1/3:", testSuccessful);
	// CHECK: JS interoperability using cheerp::jsexport __asm__ 1/3: 1
	...
	assertPrint("JS interoperability using cheerp::jsexport __asm__ 2/3:", testSuccessful2);
	// CHECK: JS interoperability using cheerp::jsexport __asm__ 2/3: 1
	client::Object* tmp;
	...
	assertPrint("JS interoperability using cheerp::jsexport __asm__ 3/3:", ret);
	// CHECK: JS interoperability using cheerp::jsexport __asm__ 3/3: 42.5
}
