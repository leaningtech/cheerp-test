...
// RUN: %run_if_js python3 %helpers/create_driver.py %t-j_es6.mjs %S/exitexception1.testing.js %t-j_es6_driver.mjs --module=es6
...
// RUN: %run_if_wasm python3 %helpers/create_driver.py %t-w_es6.mjs %S/exitexception1.testing.js %t-w_es6_driver.mjs --module=es6
...
// RUN: %run_if_asmjs python3 %helpers/create_driver.py %t-a_es6.mjs %S/exitexception1.testing.js %t-a_es6_driver.mjs --module=es6
...
// RUN: %run_if_js python3 %helpers/create_driver.py %t-j_commonjs.js %S/exitexception1.testing.js %t-j_commonjs_drives.js --module=commonjs
...
// RUN: %run_if_wasm python3 %helpers/create_driver.py %t-w_commonjs.js %S/exitexception1.testing.js %t-w_commonjs_drives.js --module=commonjs
...
// RUN: %run_if_asmjs python3 %helpers/create_driver.py %t-a_commonjs.js %S/exitexception1.testing.js %t-a_commonjs_driver.js --module=commonjs
