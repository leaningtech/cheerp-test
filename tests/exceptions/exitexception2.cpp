...
// RUN: python3 %helpers/create_driver.py %t-es6.mjs %S/exitexception2.testing.js %t-es6_driver.mjs --module=es6
// RUN: %node %t-es6_driver.mjs 2>&1 | %FileCheck %s

// RUN: %compile -cheerp-make-module=commonjs -fexceptions -o %t-commonjs.js %s 2>&1
// RUN: python3 %helpers/create_driver.py %t-commonjs.js %S/exitexception2.testing.js %t-commonjs_driver.js --module=commonjs
