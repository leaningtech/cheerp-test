...
// RUN: %compile -cheerp-make-module=es6 -I%S/../ -o %t-env.mjs %s 2>&1
// RUN: python3 %helpers/create_driver.py %t-env.mjs %S/env.testing.js %t-env_driver.mjs --module=es6
// RUN: %node %t-env_driver.mjs 2>&1 | %FileCheck %s
