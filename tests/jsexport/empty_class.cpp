...
// RUN: %run_if_js python3 %helpers/create_driver.py %t-vanilla.js %S/empty_class.testing.js %t-vanilla_driver.js --module=vanilla
...
// RUN: %run_if_js python3 %helpers/create_driver.py %t-es6.mjs %S/empty_class.testing.js %t-es6_driver.mjs --module=es6
...
// RUN: %run_if_js python3 %helpers/create_driver.py %t-commonjs.js %S/empty_class.testing.js %t-commonjs_driver.js --module=commonjs
...
// RUN: %run_if_js python3 %helpers/create_driver.py %t-closure.js %S/empty_class.testing.js %t-closure_driver.js --module=closure
...
// RUN: %run_if_wasm python3 %helpers/create_driver.py %t-w %S/empty_class.testing.js %t-w_driver.js --module=vanilla
// RUN: %run_if_wasm %node %t-w_driver.js 2>&1 | %FileCheck %s
//
// RUN: %run_if_asmjs %valgrind %compile -o %t-a %s 2>&1
// RUN: %run_if_asmjs python3 %helpers/create_driver.py %t-a %S/empty_class.testing.js %t-a_driver.js --module=vanilla
