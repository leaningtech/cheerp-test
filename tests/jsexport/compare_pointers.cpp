...
// RUN: python3 %helpers/create_driver.py %t-vanilla.js %S/compare_pointers.testing.js %t-vanilla_driver.js --module=vanilla
// RUN: %node %t-vanilla_driver.js 2>&1 | %FileCheck %s --check-prefix=CHECK

// Test ES6 module
// RUN: %compile -cheerp-make-module=es6 -o %t-es6.mjs %s 2>&1
// RUN: python3 %helpers/create_driver.py %t-es6.mjs %S/compare_pointers.testing.js %t-es6_driver.mjs --module=es6
...
// RUN: python3 %helpers/create_driver.py %t-commonjs.js %S/compare_pointers.testing.js %t-commonjs_driver.js --module=commonjs
...
// RUN: python3 %helpers/create_driver.py %t-closure.js %S/compare_pointers.testing.js %t-closure_driver.js --module=closure
