...
// RUN: regular_only run_if_js python3 %helpers/create_driver.py %t/vanilla.js %S/cat.testing.js %t/vanilla_driver.js --module=vanilla
...
// RUN: regular_only run_if_js python3 %helpers/create_driver.py %t/es6.mjs %S/cat.testing.js %t/es6_driver.mjs --module=es6
...
// RUN: regular_only run_if_js python3 %helpers/create_driver.py %t/commonjs.js %S/cat.testing.js %t/commonjs_driver.js --module=commonjs
...
// RUN: regular_only run_if_js python3 %helpers/create_driver.py %t/closure.js %S/cat.testing.js %t/closure_driver.js --module=closure
...
// RUN: regular_only run_if_wasm python3 %helpers/create_driver.py %t/w %S/cat.testing.js %t/w_driver.js --module=vanilla
...
// RUN: regular_only run_if_asmjs python3 %helpers/create_driver.py %t/a %S/cat.testing.js %t/a_driver.js --module=vanilla
