...
// RUN: regular_only run_if_wasm python3 %helpers/create_driver.py %t/vanilla %S/thread_local.testing.js %t/vanilla_driver.js --module=vanilla --pthread
...
// RUN: regular_only run_if_wasm python3 %helpers/create_driver.py %t/es6.mjs %S/thread_local.testing.js %t/es6_driver.mjs --module=es6 --pthread
...
// RUN: regular_only run_if_wasm python3 %helpers/create_driver.py %t/closure %S/thread_local.testing.js %t/closure_driver.js --module=closure --pthread
...
// RUN: regular_only run_if_wasm python3 %helpers/create_driver.py %t/commonjs %S/thread_local.testing.js %t/commonjs_driver.js --module=commonjs --pthread
