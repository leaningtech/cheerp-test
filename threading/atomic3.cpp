...
// RUN: regular_only run_if_wasm python3 %S/../helpers/create_driver.py %t/vanilla %S/atomic_common.testing.js %t/vanilla_driver.js --module=vanilla --pthread
...
// RUN: regular_only run_if_wasm python3 %S/../helpers/create_driver.py %t/es6.mjs %S/atomic_common.testing.js %t/es6_driver.mjs --module=es6 --pthread
...
// RUN: regular_only run_if_wasm python3 %S/../helpers/create_driver.py %t/closure %S/atomic_common.testing.js %t/closure_driver.js --module=closure --pthread
...
// RUN: regular_only run_if_wasm python3 %S/../helpers/create_driver.py %t/commonjs %S/atomic_common.testing.js %t/commonjs_driver.js --module=commonjs --pthread
